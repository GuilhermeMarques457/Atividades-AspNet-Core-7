...
namespace TestStock
{
    public class StockServiceTest
    {
        ...
        public void CreateBuyOrder_InvalidDate()
        {
            BuyOrderRequest? buyOrderRequest = new BuyOrderRequest()
            {
                DateAndTimeOfOrder = DateTime.Parse("1998-04-08"),
                Price = 1023,
                StockName = "Test",
                Quantity = 132,
                StockSymbol = "Test"
        ...
        public void CreateBuyOrder_ProperBuy()
        {
            BuyOrderRequest? buyOrderRequest = new BuyOrderRequest()
            {
                DateAndTimeOfOrder = DateTime.Parse("2004-04-18"),
                Price = 101,
                StockName = "Test",
                Quantity = 132,
                StockSymbol = "Test"
        ...
        public void GetAllOrders_ProperList()
        {
            List<BuyOrderRequest> buyOrderRequests = new List<BuyOrderRequest>()
            {
                new BuyOrderRequest()
                {
                    DateAndTimeOfOrder = DateTime.Parse("20-04-2005"),
                    Price = 101,
                    StockName = "Teste2",
                    Quantity = 132,
                    StockSymbol = "Teste1"
        ...
        public void CreateSellOrder_MaxQtde()
        {
            SellOrderRequest? sellOrderRequest = new SellOrderRequest()
            {
                DateAndTimeOfOrder = DateTime.Parse("2004-04-19"),
                Price = 123,
                StockName = "Test",
                Quantity = 100001,
                StockSymbol = "Test",
        ...
        public void CreateSellOrder_ProperBuy()
        {
            SellOrderRequest? sellOrderRequest = new SellOrderRequest()
            {
                DateAndTimeOfOrder = DateTime.Parse("2006-04-18"),
                Price = 101,
                StockName = "Test",
                Quantity = 132,
                StockSymbol = "Test"
        ...
        public void GetAllSells_ProperList()
        {
            List<SellOrderRequest> sellOrderRequests = new List<SellOrderRequest>()
            {
                ...
                {
                    DateAndTimeOfOrder = DateTime.Parse("20-04-2004"),
                    Price = 101,
                    StockName = "Teste2",
                    Quantity = 132,
                    StockSymbol = "Teste1"
